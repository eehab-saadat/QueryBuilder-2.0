...
from main import (
    ...
    classification_agent, Runner, trace,
)
...
st.set_page_config(page_title="Medical SQL Assistant 🏥", page_icon="🏥")
...
with st.sidebar:
    st.header("About")
    st.info("Medical SQL Assistant - Ask questions about patient data")
